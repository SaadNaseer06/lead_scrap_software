                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="front_sale" {{ old('role') === 'front_sale' ? 'selected' : '' }}>Front Sale</option>
                            <option value="upsale" {{ old('role') === 'upsale' ? 'selected' : '' }}>Upsale</option>
                            <option value="scrapper" {{ old('role') === 'scrapper' ? 'selected' : '' }}>Scrapper</option>
                        </select>
                        @error('role')
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span>
                        @enderror
